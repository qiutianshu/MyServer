...
typedef struct {		/* Bitreading state saved across MCUs */
  ...
  unsigned int printed_eod;		/* flag to suppress multiple warning msgs */
} bitread_perm_state;
...
typedef struct {		/* Bitreading working state within an MCU */
  ...
  unsigned int * printed_eod_ptr;	/* => flag in permanent state */
...
EXTERN(unsigned int) jpeg_fill_bit_buffer
