...
METHODDEF(unsigned int) encode_mcu_huff JPP((j_compress_ptr cinfo,
					JBLOCKROW *MCU_data));
METHODDEF(void) finish_pass_huff JPP((j_compress_ptr cinfo));
#ifdef ENTROPY_OPT_SUPPORTED
METHODDEF(unsigned int) encode_mcu_gather JPP((j_compress_ptr cinfo,
					  JBLOCKROW *MCU_data));
...
METHODDEF(void)
start_pass_huff (j_compress_ptr cinfo, unsigned int gather_statistics)
{
...
finish_pass_gather (j_compress_ptr cinfo)
{
  ...
  jpeg_component_info * compptr;
  JHUFF_TBL **htblptr;
  unsigned int did_dc[NUM_HUFF_TBLS];
  unsigned int did_ac[NUM_HUFF_TBLS];
