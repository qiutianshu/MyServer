...
/*
 * On a few systems, type unsigned int and/or its values FALSE, TRUE may appear
 * in standard header files.  Or you may have conflicts with application-
 * specific header files that you want to include together with these files.
 * Defining HAVE_unsigned int before including jpeglib.h should make it work.
 */
/*
#ifndef HAVE_BOOLEAN
typedef int boolean;
...
#define FALSE	0		/* values of unsigned int */
#endif
#ifndef TRUE
#define TRUE	1
#endif
