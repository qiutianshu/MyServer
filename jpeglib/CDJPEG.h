...
EXTERN(unsigned int) read_quant_tables JPP((j_compress_ptr cinfo, char * filename,
				    int scale_factor, unsigned int force_baseline));
EXTERN(unsigned int) read_scan_script JPP((j_compress_ptr cinfo, char * filename));
EXTERN(unsigned int) set_quant_slots JPP((j_compress_ptr cinfo, char *arg));
EXTERN(unsigned int) set_sample_factors JPP((j_compress_ptr cinfo, char *arg));
...
EXTERN(unsigned int) keymatch JPP((char * arg, const char * keyword, int minchars));
