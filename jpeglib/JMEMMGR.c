...
struct jvirt_sarray_control {
  ...
  unsigned int pre_zero;		/* pre-zero mode requested? */
  unsigned int dirty;		/* do current buffer contents need written? */
  unsigned int b_s_open;		/* is backing-store data valid? */
...
request_virt_sarray (j_common_ptr cinfo, int pool_id, unsigned int pre_zero,
		     JDIMENSION samplesperrow, JDIMENSION numrows,
...
request_virt_barray (j_common_ptr cinfo, int pool_id, unsigned int pre_zero,
		     JDIMENSION blocksperrow, JDIMENSION numrows,
		     JDIMENSION maxaccess)
...
LOCAL(void)
do_sarray_io (j_common_ptr cinfo, jvirt_sarray_ptr ptr, unsigned int writing)
...
LOCAL(void)
do_barray_io (j_common_ptr cinfo, jvirt_barray_ptr ptr, unsigned int writing)
