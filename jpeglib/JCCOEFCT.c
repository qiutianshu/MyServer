...
METHODDEF(unsigned int) compress_data
    JPP((j_compress_ptr cinfo, JSAMPIMAGE input_buf));
#ifdef FULL_COEF_BUFFER_SUPPORTED
METHODDEF(unsigned int) compress_first_pass
    JPP((j_compress_ptr cinfo, JSAMPIMAGE input_buf));
METHODDEF(unsigned int) compress_output
    JPP((j_compress_ptr cinfo, JSAMPIMAGE input_buf));
#endif
...
GLOBAL(void)
jinit_c_coef_controller (j_compress_ptr cinfo, unsigned int need_full_buffer)
{
  my_coef_ptr coef;
